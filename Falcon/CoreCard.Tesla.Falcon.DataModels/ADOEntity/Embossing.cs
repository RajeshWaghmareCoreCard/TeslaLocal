...
namespace CoreCard.Tesla.Falcon.DataModels.Entity
{
    ...
    public class Embossing : BaseEntity
    {
        [Key]
        public Guid embossingid { get; set; }
        ...
        public static implicit operator Embossing(DataRow dr)
        {
            Embossing o = new Embossing();
            if (dr.IsNull("embossingid") == false)
            {
                o.embossingid = dr.Field<Guid>("embossingid");
            }
            ...
            if (dr.IsNull("cardtype") == false)
            {
                o.cardtype = Convert.ToInt32( dr.Field<Int64>("cardtype"));
            }
